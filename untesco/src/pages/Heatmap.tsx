...
const OVERALL = 67;
const R       = 37;
const CIRCUM  = 2 * Math.PI * R; // ≈ 232.5
      ...
      <div className="ring-card card">
        ...
        <div className="ring-info">
          ...
          <div className="ring-stats">
            <div>
              <div className="ring-stat-val clr-green">4</div>
              <div className="ring-stat-key">Сильных</div>
            </div>
            <div>
              <div className="ring-stat-val clr-amber">4</div>
              <div className="ring-stat-key">Средних</div>
            </div>
            <div>
              <div className="ring-stat-val clr-red">2</div>
              <div className="ring-stat-key">Слабых</div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div key={t.name} className="heat-row">
              ...
              <div className="pbar-wrap">
                <div
                  ...
                  style={{
                    width: 0,
                    transition: `width 0.6s cubic-bezier(0.22,1,0.36,1) ${i * 55}ms`,
                  }}
                  ref={(el) => {
                    if (el) {
                      requestAnimationFrame(() => {
                        el.style.width = `${t.pct}%`;
                      });
                    }
                  }}
                />
