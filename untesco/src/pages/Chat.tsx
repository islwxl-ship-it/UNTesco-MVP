...
const ANALOGY_TEXT = 'Представь, что квадратное уравнение — это лук со стрелой. Парабола — это траектория полёта стрелы. Корни уравнения — это точки, где стрела касается земли. Если стрела летит слишком высоко и никогда не упадёт — корней нет. Если она едва касается земли — один корень. Если пролетает насквозь — два корня.';
...
function UserAvatar() {
  return <div className="msg-ava msg-ava-user">АС</div>;
}
...
export default function Chat() {
  ...
  function addAnalogy() {
    ...
    setAnalogyUsed(true);
    setMessages(prev => [...prev, { role: 'ai', isAnalogy: true, analogyText: ANALOGY_TEXT, time: now() }]);
  }
